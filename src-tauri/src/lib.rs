...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::save_png,
            commands::new_pack_workspace,
            commands::open_pack_workspace,
            commands::list_workspace_layouts,
            commands::read_workspace_layout,
            commands::save_workspace_layout,
            commands::delete_workspace_layout,
            commands::close_pack_workspace,
            commands::pack_workspace_status,
